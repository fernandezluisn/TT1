...
boxplot(boxp2, main="EMA patrones", col = c("blue", "red"))

#bias  (actual - predicted).

total<-as.numeric(t(patrones_Tot[4,3:32]))*-1
parcial<-as.numeric(t(patrones_parc[4,3:32]))*-1
summary(total)
summary(parcial)
...
boxplot(boxp2, main="sesgo patrones", col = c("blue", "red"))
...
boxplot(boxp2, main="EMA asalariados", col = c("blue", "red"))

#bias  (actual - predicted).

total<-as.numeric(t(asalariados_tot[4,3:32]))*-1
parcial<-as.numeric(t(asalariados_parc[4,3:32]))*-1
summary(total)
summary(parcial)
...
boxplot(boxp2, main="sesgo asalariados", col = c("blue", "red"))
