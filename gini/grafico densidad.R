...
##AA2
baseTrain<-baseTrain[,c("Y","INF", "CH06","CH04","rol", "rama.eph", "NIVEL_ED", "car1","car2", 
                        "AGLOMERADO", "PP07H", "PP07A", "PP07E", "CH03", "CH15", "PP03D","TECNO", 
                        "PP3E_TOT", "CH11", "CH08", "CH09", "PP04C", "CH16", "PP04B1",
                        "PP05C_1", "PP05C_2", "PP05C_3", "REGION", "JERARQUIA", "CAT_OCUP")]
...
predict(m1,basePredict)->basePredict$P21_AA_log
basePredict$P21_AA_log_final<-exp(as.numeric(basePredict$P21_AA_log))

plot(density(log(basePredict$P21_AA)), col="red", main="densidad log P21 imputada")
lines(density(log(basePredict$P21)), col="black")
lines(density(log(basePredict$P21_final)), col="blue")
lines(density(basePredict$P21_AA_log), col="red4")

legend("topleft",legend = c("Declarado", "AA", "AA log","RLMR"), fill = c("black", "red", "red4","blue"))
